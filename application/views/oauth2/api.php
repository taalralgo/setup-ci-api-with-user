...
$(document).ready(function(){
    $("#btn-refresh").click(function (e){
        ...
        $.post('/code/RefreshToken', data, function (d){
    ...
    $('#btn-authorize').click(function (e){
        ...
        $.post('/code/authorize/token', data, function (d){
    ...
    $('#btn-resource').click(function (e){
        ...
        $.post('/code/resource', data, function (d){
    ...
    $('#btn-resource-limit').click(function (e){
        ...
        $.post('/code/resource/limit', data, function (d){
            console.log("Get Authorize => ", d);
            $('#return-resource').html(JSON.stringify(d));
        },"json");      
    });
    ...
    $('#btn-PasswordCredentials').click(function (e){
        ...
        // console.log(data);
        $.post('/code/PasswordCredentials', data, function (d){
    ...
    $("#btn-ClientCredentials").click(function (e){
        ...
        $.post('/code/ClientCredentials', data, function (d){
            //d = d.JSON.parse(d);
